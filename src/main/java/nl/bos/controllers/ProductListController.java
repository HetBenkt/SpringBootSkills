...
public class ProductListController extends ApiController {
	...
	public ProductList insertProductList(@RequestBody ProductList productList) {
	...
	public ProductList addProductToProductList(@PathVariable("productListId") long productListId, @RequestParam("productId") long productId) {
		ProductList result;
		...
		if(productList != null) { 
			...
			result = productListRepository.save(productList);
		} else
